@echo off
cd /d %~dp0
set /p execute= This process will delete all unnecessary log files created by the miners and MiningPoolMiner to free up space. Are you sure you want to continue? [Y/N] 
IF /I "%execute%"=="Y" (
